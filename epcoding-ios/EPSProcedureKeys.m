...
+ (NSDictionary *)keyDictionary
{
    ...
    if (dictionary == nil) {
        ...
        [dictionary setObject:[[EPSProcedureKey alloc] initWithPrimaryKey:@"subQIcdPrimaryCodes" secondaryKey:@"icdReplacementSecondaryCodes" disabledKey:NO_CODE_KEY disablePrimaryCodes:NO ignoreNoSecondaryCodesSelected:NO] forKey:SUBQ_ICD_TITLE];
