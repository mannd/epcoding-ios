...
+ (NSDictionary *)keyDictionary
{
    ...
    if (dictionary == nil) {
        ...
        [dictionary setObject:[[EPSProcedureKey alloc] initWithPrimaryKey:@"epTestingPrimaryCodes" secondaryKey:@"epTestingSecondaryCodes" disabledKey:@"ETestingDisabledCodes" disablePrimaryCodes:NO ignoreNoSecondaryCodesSelected:YES] forKey:EP_TESTING_TITLE];
        ...
        [dictionary setObject:[[EPSProcedureKey alloc] initWithPrimaryKey:@"upgradeSystemPrimaryCodes" secondaryKey:@"upgradeSystemSecondaryCodes" disabledKey:NO_CODE_KEY disablePrimaryCodes:NO ignoreNoSecondaryCodesSelected:NO] forKey:UPGRADE_SYSTEM_TITLE];
