...
- Code analysis marks common errors, but is no substitute for a
  professional coder!
- Only a subset of ICD-10-CM codes are included--those relevant to cardiology.  For example, I did not include V91.07XA Burn due to water-skis on fire, initial encounter.
